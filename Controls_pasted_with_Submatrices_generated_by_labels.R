...
if (  (names(list_of_submatrices)[Position_of_controls] == "Control") == TRUE ){
  print("You have a Label of -Control- that will be used for furhter processing")
} else{
...
saveRDS(list_of_submatrices , file = paste0(Path_of_Results,"List_of_Control_with_subexpression_matrix_of_",Title_of_Results,".RDS" ))
