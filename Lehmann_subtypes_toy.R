...
#experimentData(just.stromal.properties)
#exprs(just.stromal.properties)
#sampleNames(just.stromal.properties)
#featureNames(just.stromal.properties)
#head(pData(just.stromal.properties))
#featureData(just.stromal.properties)
#phenoData(just.stromal.properties)
#varLabels(phenoData(just.stromal.properties))
